...
The implementation of the Cojen/Maker system is relatively small, and it has no dependencies. The release jar size is 214KiB, which includes all debugging information.
